...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['INVSY_BASE_URL'].
   */
...
/**
 * API Client for interfacing with the Invsy API.
 */
export class Invsy extends Core.APIClient {
  private _options: ClientOptions;

  /**
   * API Client for interfacing with the Invsy API.
   *
   * @param {string} [opts.baseURL=process.env['INVSY_BASE_URL'] ?? https://localhost:8080/test-api] - Override the default base URL for the API.
   ...
   */
  constructor({ baseURL = Core.readEnv('INVSY_BASE_URL'), ...opts }: ClientOptions = {}) {
  ...
  static InvsyError = Errors.InvsyError;
